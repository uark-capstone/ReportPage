...
window.onload = function () {
    ...
    //Place json data into the dictionary of arrays to be plotted//
    //Based on the catagories given at https://docs.aws.amazon.com/rekognition/latest/dg/API_Emotion.html
    //
    ...
    var surpriseScore = 0;
    var happyScore = 0;
    var comments = ["No news is better than good news!", "Quiet day today!", "Great job, as always!",
        "It looks like they really liked what you had to say!", "You made them laugh a lot today!",
        "Looks like they really learned a lot!", "Great job, you're really engaging your students!", "Looks like your students were a little sad today.",
        "Looks like some students were grossed out!", "Looks like a few students actually got scared! Yikes!"
    ...
    for (i = 0; i < jsonData.length; i++) {
        var time = new Date(jsonData[i].timestamp).toLocaleTimeString("GMT", {hour: "2-digit",minute: "2-digit"});
        if (time.charAt(0) === '0') {
